...
from src.app.api.dependencies import enforce_rate_limit, get_current_user
from src.app.features.auth.models import AuthUser
from src.app.features.extensions.schemas import (
...
from src.app.features.extensions.connection_service import build_oauth_state_connection_service
from src.app.features.extensions.connections_service import SUPPORTED_CONNECTION_PROVIDERS
...
async def handle_connection_callback(
    ...
    provider_name = _connection_provider_or_400(provider)
    service = build_oauth_state_connection_service(provider=provider_name, state=state)
