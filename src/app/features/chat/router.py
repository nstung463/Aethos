...
from src.app.features.auth.schemas import PermissionProfilePayload
...
from src.app.features.chat.schemas import (
    ChatRequest,
...
async def generate_title(
    ...
    if isinstance(profile_payload, dict):
        provider = str(profile_payload.get("provider", "")).strip().lower()
        if provider == "openai_compatible" and not settings.allow_custom_provider_endpoints:
